...
router.get('/', async (req, res) => {
    try {
        ...
        const [values2] = loadDataPlayer("Luc4gbox");        //  const [days2, values2] = loadDataPlayer("Luc4gbox");
        const [values3] = loadDataPlayer("Tristan");         // const [days3, values3] = loadDataPlayer("Tristan");
